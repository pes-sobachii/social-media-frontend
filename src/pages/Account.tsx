...
import {Room, Wc, DateRange, PostAdd, AccountBox, SupervisedUserCircle} from '@mui/icons-material';
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <div className={styles.bio}>
                        <ul>
                            <li><DateRange/>Age: {String(userData.age)}</li>
                            <Divider/>
                            <li><Wc/>Gender: {userData.gender}</li>
                            <Divider/>
                            <li><Room/>Location: {userData.city}</li>
                        </ul>
                    </div>
